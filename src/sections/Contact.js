...
const Contact = () => {
  return (
    <div className="isolate bg-white px-6 py-24 mt-20 rounded-xl dark:bg-gray-900  sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl  text-gray-800 font-extrabold  tracking-tight text-balance   dark:text-gray-100 sm:text-5xl">
          Contact Me
        </h2>
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white px-3.5 py-2 border text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
              />
            </div>
          </div>
          <div>
              ...
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
                <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                  <select
                    ...
                    aria-label="Country"
                    className="border dark:text-gray-900 col-start-1 row-start-1 w-full appearance-none rounded-md py-2 pr-7 pl-3.5 text-base text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  >
                    <option className="dark:text-gray-100 ">US</option>
                    <option className="dark:text-gray-100 ">CA</option>
                    <option className="dark:text-gray-100 ">EU</option>
                  </select>
                  {/* <ChevronDownIcon
                    aria-hidden="true"
